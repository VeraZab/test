...
const codeSections = [
    {
        id: "a",
        text: 'Create a button or link on your page with an ID "plotly-data-export". Make sure your page is loading jQuery.',
        code: `<a href="#" id="plotly-data-export" target="_blank">Graph in Plotly</a>`,
        lang: 'html'
    },
    {
        id: "b",
        text: 'Create a global JavaScript function called getPlotlyGridData(). This function should return the data you want to be available to graph. See the code below for the correct syntax. In this example, "Data", "Amount", and "Source" will be column headers in the Plotly spreadsheet.',
        code: `<script>
...
const lastSection = [
    {
        id: "a",
        text: 'Create a button or link on your page with an ID "plotly-graph-export". Make sure your page is loading jQuery.',
        code: `<a href="#" id="plotly-graph-export" target="_blank">Graph in Plotly</a>`,
        lang: 'html'
    },
    {
        id: "b",
        text: 'Create a global JavaScript called getPlotlyGraphData(). This function should return the data you want to graph. See the code below for the correct syntax.',
        code: `<script>
    ...
    <div className="export-page-main">
        <div className="quote-section">
            <div className="quote-wrapper">
                <div className="quote-item">
                    <div className="quote-item-wrapper">
                        <div className="quote-item-quote">
                            <span>"</span>Plotly makes it easy to share and edit your work privately, with your
                            co-workers, or the
                            world. There is so much to learn from open government data and we are happy to feature tools
                            like Plotly and CartoDB that make it easier for everyone to become a data
                            scientist.<span>"</span>
                        </div>
                ...
                <div className="quote-item">
                    <div className="quote-item-wrapper">
                        <div className="quote-item-quote">
                            <span>"</span>Why did we choose Plot.ly for our first integration? Because we’re a great
                            match! Both our platforms are designed to make the power of data more
        ...
        <ContentSection>
            <ContentPane full center center-vertically text>
                ...
                <Body>
                <p>
                    View a showcase of how our partners are using the export option and how it is benefiting their
                    users.
                </p>
        ...
        <ContentSection>
            <ContentPane full center-vertically text>
                ...
                <Title>
                    Export data into Plotly from an existing endpoint
                </Title>
                <Body>
                ...
                <article className="export-step">
                    <div className="export-step-title">
                        ...
                        <div className="export-step-text">
                            <p>For this example, we’re using this <a
                                href="https://www.quandl.com/api/v1/datasets/NVCA/VENTURE_3_10.csv">endpoint
                                from Quandl.</a></p>
                        </div>
                    </div>
                    ...
                    <div className="export-step-title">
                        ...
                        <div className="export-step-text">
                            <p>
                                ...
                                <strong>You can also sync Plotly graphs with arbitrary externally sourced data.</strong> These graphs can
                                be
                                shared by a URL and embedded in a webpage, and whenever a user views the graph, Plotly
                                fetches
                                the latest data from your web service.

                            </p>
                            <p>
                                Use the external source plotter when you don’t want
                                to send your user to Plotly’s web-app.
                            </p>
                            <p>

                                We have examples documented for <a
                                href="http://chriddyp.github.io/external-source-plotter/sqlite/"
                                target="_blank">SQLite</a>, <a
                                href="http://chriddyp.github.io/external-source-plotter/tickers/"
                                target="_blank">Flask</a>, <a
                                href="http://chriddyp.github.io/external-source-plotter/quandl/"
                                target="_blank">Quandl</a>, <a
                                href="http://chriddyp.github.io/external-source-plotter/google-drive/" target="_blank">Google
                                Drive</a>, <a href="http://chriddyp.github.io/external-source-plotter/github-gist/"
                                              target="_blank">GitHub
                                Gists,</a> and <a href="http://chriddyp.github.io/external-source-plotter/dropbox/"
                                                  target="_blank">Dropbox</a>. <a
                                href="http://chriddyp.github.io/external-source-plotter/" target="_blank">See it in
                                action or read more about it</a>
                            </p>
                        </div>
                    </div>
                    <div className="export-step-body">
                    ...
                    codeSections.map((section, i) => {
                        return (
                            <article className="export-step">
                                ...
                                <div className="export-step-body">
                                    <SyntaxHighlighter language={section.lang}
                                                       style={github}
