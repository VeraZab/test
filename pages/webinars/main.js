                                    ...
                                    <div className="webinar" key={i}>
                                        <div className="webinar-wrapper">
                                            <div className="webinar-section">
                                                <div className="webinar-img">{webinar.img ? (<div className="webinar-img-wrapper" style={{backgroundImage: 'url(' + webinar.img + '?w=100&h=100&fit=crop)', backgroundSize: 'cover', backgroundPosition: 'center center' }} />) : ''}</div>
