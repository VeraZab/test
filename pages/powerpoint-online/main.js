...
export default () => (
  <div>
      ...
      <ContentPane half center-vertically text>
        ...
        <Body>
          <p>
            ...
            based slide decks using a drag & drop interface
          </p>
        </Body>
      </ContentPane>
      <ContentPane half graphic>
        <Graphic image="https://marketing.plot.ly/static/marketing/assets/images/powerpoint-online/drag-drop.gif" />
      </ContentPane>
    </ContentSection>
    {/*2 graphics*/}
    <ContentSection>
      <ContentPane half center-vertically>
        <Graphic
          label="Google: Quarterly Earnings"
    ...
    <ContentSection>
      <ContentPane half graphic>
        <Graphic image="https://marketing.plot.ly/static/marketing/assets/images/powerpoint-online/screenshot-chart.png?auto=compress&auto=format" />
      </ContentPane>
      <ContentPane half center-vertically text>
        <Title>Embed straight from Plotly</Title>
        <Body>
          <p>
            Embed interactive, D3.js charts and dashboards from your Plotly
            account.
          </p>
        </Body>
      </ContentPane>
    ...
    <ContentSection>
      <ContentPane half center-vertically>
        <Graphic
          label="a16z: Mobile Ate the World"
    ...
    <ContentSection>
      <ContentPane full center center-vertically text>
        ...
        <Body>
          <p>Share your presentation online with public or secret links.</p>
        </Body>
      </ContentPane>
    </ContentSection>
  </div>
