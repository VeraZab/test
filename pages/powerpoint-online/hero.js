  ...
  [
    {
      ...
      target: '_blank',
      link:
        'https://images-plotly.imgix.net/spectacle-editor/Spectacle.Editor-0.1.4.dmg',
      button: {
    ...
    },
    {
      ...
      target: '_blank',
      link:
        'https://images-plotly.imgix.net/spectacle-editor/Spectacle.Editor.Setup.0.1.4.exe',
      button: {
        classes: 'button button-primary',
      },
    },
  ...
  render() {
    return (
      <Hero heroWrapperStyle={HeroWrapperStyle}>
        <HeroTop>
          <HeroMessaging>
            <HeroTitle>Plotly Slide Decks</HeroTitle>
            <HeroSubtitle>
              Create and share Powerpoint-like slide decks online that have
