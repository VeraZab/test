...
const tabsData = [
  {
    ...
    slug: 'make-a-chart',
    icon:
      'https://images-plotly.imgix.net/plotly-marketing-pages/images/new-branding/icons/ create-items-icons/images/ic_chart_28@2x.png?auto=compress&auto=format',
    content: {
      heading: 'Expressive Charts',
      graphic_type: 'image',
      graphic_src:
        'https://s3-us-west-1.amazonaws.com/plotly-tutorials/plotly-marketing-pages/images/new-branding/graphics/plotly_home_graph.png?auto=compress&auto=format',
      description:
  ...
  },
  {
    ...
    icon:
      'https://images-plotly.imgix.net/plotly-marketing-pages/images/new-branding/icons/ create-items-icons/images/ic_dashboard_28@2x.png?auto=compress&auto=format',
    content: {
      heading: 'Dazzling Dashboards',
      graphic_type: 'image',
      graphic_src:
        'https://images-plotly.imgix.net/static/marketing/powerful_dashboards.png?auto=compress&auto=format',
      description:
        'These aren’t your dad’s dashboards. Plotly dashboards are web-based, scriptable in Python and R, and feature Plotly’s best-in-class D3 graphics.',
  ...
  },
  {
    ...
    icon:
      'https://images-plotly.imgix.net/plotly-marketing-pages/images/new-branding/icons/ create-items-icons/images/ic_presentation_28@2x.png?auto=compress&auto=format',
    content: {
      heading: 'Spectacle Slide Decks',
      graphic_type: 'image',
      graphic_src:
        'https://images-plotly.imgix.net/static/marketing/stunning-presentations.png?auto=compress&auto=format',
      description:
        'Create, present, and share online slide decks that have interactive Plotly charts.',
  ...
  render() {
    let mobileTabsLeft = () => {
      if (this.state.tab.id > 1) {
        return (
          <div
            className="tab pagination active"
            onClick={() => {
              this.prev()
            }}
          >
        ...
        return (
          <div className="tab pagination active not-clickable">
            <div className="tab-label">
              <svg viewBox="0 0 24 24">
                <path
                  fill="#000000"
      ...
      <div className={`tab active`}>
        <div className="tab-icon">
          <div className="img-wrap">
            <img src={this.state.tab.icon} alt={this.state.tab.title} />
          </div>
        </div>
        <div className="tab-label">{this.state.tab.title}</div>
      </div>
    )
    ...
    let tabsContent = tabsData.map(tab => {
      return (
        <div
          key={tab.id}
          className={`tabs-content ${this.state.tab.id === tab.id
            ? 'active'
            : ''}`}
        >
            ...
            <div className="panes panes-half">
              <div className="pane">
                <div className="graphic graphic-browser">
                  <BrowserWrapper>
                    <img src={tab.content.graphic_src} alt={tab.title} />
                  </BrowserWrapper>
                </div>
              </div>
        ...
        <div className="tabs">
          <StickyContainer>
            <div className="tabs-header">
              <div className="tabs-header-wrapper mobile-up">{tabs}</div>
              <Sticky
                topOffset={-72}
                bottomOffset={148}
            ...
            <div className="mobile-up hidden delay-med">{tabsContent}</div>
