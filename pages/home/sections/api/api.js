  ...
  <div>
    <ContentSection className="background-color-light-1 center not-mobile">
      <ContentPane full center center-vertically>
        <div className="pre-title">Develop</div>
        <Title>
          The fastest growing charting libraries for R, Python, and Javascript
        </Title>
        <Body>
          <p>
            Plotly's open-source, interactive charting libraries for R, Python,
            and JavaScript are the fastest growing charting libraries in each
            language. Work entirely offline in IDEs like RStudio or Jupyter
            notebook, or optionally host your work on Plotly Cloud or Plotly
            On-Premises. Hosting Plotly charts online allows developers and data
            scientists to collaborate effortlessly with analysts who do not
            code.
          </p>
        </Body>
      </ContentPane>
    ...
    <ContentSection className="background--oem">
      <ContentPane half center-vertically text className="sixy-five">
        ...
        <h2 className="content-section-h2">
          Plotly is the leading data visualization technology provider. With our
          open-source software, we help companies launch cutting edge, data
          visualization UIs in their products and internal analytics platforms.
        </h2>
        <Body>
          <p>
            ...
            years of launching successful data visualization products, we’re on
            a mission to make every analytics product have first-class data
