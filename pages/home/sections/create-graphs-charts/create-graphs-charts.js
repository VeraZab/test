...
export default () => (
  <ContentSection className="background--dotted-lines">
    <ContentPane half center-vertically text>
      ...
      <Title>Create graphs and charts</Title>
      <Body>
        <p>
          Easily create stunning and informative graphics using our
          sophisticated, open source, visualization library and our online chart
          creation tool.
        </p>
        <p>
          Take a look at the chart types that our APIs support and view our
          community feed.
        </p>
