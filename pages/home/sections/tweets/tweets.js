...
export default () => (
  <ContentSection className="white center">
    <div className="content-section-header">
      <div className="pre-title">Follow</div>
    ...
    <div className="content-section-body">
            ...
            <div className="card-wrapper">
              <div className="card-details">
                <div className="sub-title">
                  3 steps to set up Plotly's free and open-source chart-to-SQL
      ...
      <div className="buttons center gutter-top">
        <div className="button button-primary">Follow @plotlygraphs</div>
      </div>
    </div>
  </ContentSection>
)
