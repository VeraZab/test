...
export default () => (
    <ContentSection className="dark-blue center">
        ...
        <ContentPane full center center-vertically>
            ...
            <Title>
                Make stunning slide decks and dashboards.
            </Title>
            <Body>
            <p>Easily share your findings by embedding them into a web page, exporting them into pdf, png, svg, eps
                formats, or creating custom <a href="https://plot.ly/powerpoint-online/"
                                               target="_blank">slide decks</a> and <a
