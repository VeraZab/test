...
export default () => (
    <div>
        <ContentSection >
            <ContentPane half center-vertically text>
                ...
                <ul className="hero-list">
                    ...
                    <li>Optional hosted sharing platform through <a href="/products/on-premise/" target="_blank">Plotly
                        On-Premises</a> or <a href="/products/cloud/" target="_blank">Plotly Cloud</a>.
                    </li>
                </ul>
                </Body>
            </ContentPane>
            <ContentPane half graphic>
                <Graphic
                    image="https://images-plotly.imgix.net/static/marketing/chart_graphic.png?auto=compress&auto=format"/>
            </ContentPane>
        </ContentSection>
        ...
        <ContentSection>
            <ContentPane half graphic>
                <Graphic
                    image="https://camo.githubusercontent.com/09183b0e60c303d96a22e999cd69c81b1dcfe302/687474703a2f2f692e696d6775722e636f6d2f655671735a6d612e676966"/>
            </ContentPane>
            <ContentPane half center-vertically text>
                <Title>
        ...
        <ContentSection>
            <ContentPane half center-vertically text>
                ...
                <Body>
                <p>
                    No need to learn a new chart syntax: One line of code converts a ggplot2 static chart to an
                    interactive Plotly version.
                </p>
                <p>
                    <a href="https://cpsievert.github.io/plotly_book/extending-ggplotly.html#extending-ggplotly"
        ...
        <ContentSection>
            ...
            <ContentPane half center-vertically text>
                ...
                <Body>
                <p>
                    Make D3.js and WebGL charts with the ease, power, and open-source ecosystem of R. Plotly charts and
                    dashboards can be easily styled in R, or uploaded to Plotly’s online editor for point-&-click
        ...
        <ContentSection>
            ...
            <ContentPane half center-vertically text>
                ...
                <p>
                    ...
                    to Python users (and vice versa) through Plotly Cloud, Plotly On-Premises, or entirely offline.
                ...
                <p>
                    ...
                    users through Plotly On-Premises and Plotly Cloud.
                </p>
