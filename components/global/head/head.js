...
export default ({children, meta = defaultMeta}) => (
        <Head>
            ...
            <meta name="twitter:title" content={meta.title ? meta.title : defaultMeta.title} />
            <meta name="twitter:description" content={meta.description ? meta.description : defaultMeta.description} />
            ...
            {meta.twitter && meta.twitter.label1 ? (<meta name="twitter:label1" content={meta.twitter.label1} />) : null}
            {meta.twitter && meta.twitter.data1 ? (<meta name="twitter:data1" content={meta.twitter.data1} />) : null}
            {meta.twitter && meta.twitter.label2 ? (<meta name="twitter:label2" content={meta.twitter.label2} />) : null}
