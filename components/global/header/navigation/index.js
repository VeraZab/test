            ...
            <div className="site-header-navigation">
                ...
                <div className={'site-header-navigation-wrapper'}>
                    ...
                    <nav className={"site-header-nav" + this.mobileMenuClasses()}>
                        {/** Consulting */}
                        <Link href="/products/consulting-and-oem/" prefetch><a className="navigation-product-item"
                        >Consulting</a></Link>
                        ...
                        <div className="navigation-product-item-with-submenu">
                            ...
                            <div className="navigation-product-submenu">
                                <Link href="/products/cloud" prefetch><a className="navigation-product-submenu-item"
                                                                         href="/products/cloud">Plotly
                                    Cloud</a></Link>
                                <Link href="/products/on-premise" prefetch><a
                        ...
                        <div className="navigation-product-item-with-submenu">
                            ...
                            <div className="navigation-product-submenu navigation-product-submenu--large">
                                ...
                                <div className="navigation-product-submenu-section">
                                    ...
                                    <Link href={{pathname: '/prismic/chart-studio'}}
                                          as={'/online-chart-maker/'} prefetch><a
                                        className="navigation-product-submenu-item">Chart
                                        Studio</a></Link>
                                    <Link href={{pathname: '/prismic/dashboards-and-reporting'}}
                                          as={'/dashboards/'} prefetch><a className="navigation-product-submenu-item"
                                                                          href="/dashboards">Dashboard
                                        & Reporting</a></Link>
                                    <Link href={{pathname: '/prismic/slide-decks'}}
                                          as={'/powerpoint-online/'} prefetch><a
                                        className="navigation-product-submenu-item" href="/powerpoint-online/">Slide
                                        Decks</a></Link>
                                    <Link href={{pathname: '/prismic/falcon'}}
                                          as={'/database-connectors/'} prefetch><a
                                        className="navigation-product-submenu-item">Falcon
                                        SQL
                                        Client (Free)</a></Link>
                                </div>
                                ...
                                <div className="navigation-product-submenu-section">
                                    ...
                                    <Link href="/plotly-js-scientific-d3-charting-library/" prefetch><a
                                        className="navigation-product-submenu-item"
                                    >Plotly.js</a></Link>
                                    <Link href="/d3-js-for-python-and-pandas-charts/" prefetch><a
                                        className="navigation-product-submenu-item"
                                    >Plotly.py</a></Link>
                                    <Link href="/d3-js-for-r-and-shiny-charts/" prefetch><a
                                        className="navigation-product-submenu-item"
                                    >Plotly.R</a></Link>
                                </div>
