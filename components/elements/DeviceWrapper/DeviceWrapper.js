  ...
  render() {
    ...
    return (
      <div className={'device-wrapper'} style={device.styles}>
        <div
          className={`device-svg ${content.color}`}
...
const devices = {
  ...
  report: {
    ...
    svg:
      '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="264.1 0 431.7 560" enable-background="new 264.1 0 431.7 560" xml:space="preserve"><path d="M622.9,2.4v68.4v2.2h2.4h68v484.6H266.6V2.4H622.9 M625.3,0H264.1v560h431.7V70.6h-70.5V0L625.3,0z"></path><path d="M640.4,6.1l49.8,51.2h-49.8V6.1 M638,0v59.7h58.1L638,0L638,0z"></path></svg>'
  }
};
