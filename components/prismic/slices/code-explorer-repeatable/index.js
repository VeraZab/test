...
export default class CodeExplorerRepeatable extends React.Component {
  ...
  render() {
    ...
    const mobileTab = (
      <div className={'code-explorer-slice__content__header__item mobile active disabled'}>
        <div className="label">{tab.primary.label}</div>
      </div>
    );
        ...
        <div className="code-explorer-slice__wrapper">
          <div className="code-explorer-slice__content">
            <div className="code-explorer-slice__content__image js-code-explorer__image">
              {tab.primary.visual_code_iframe_url ? (
                ...
                <CodeVisual
                  ...
                  layout={
                    tab.primary.visual_code_layout_url ? tab.primary.visual_code_layout_url : null
                  }
                />
              )}
            </div>
            <div className="code-explorer-slice__content__code">
              ...
              <div className="code-explorer-slice__content__code__footer">{actions()}</div>
            </div>
          </div>
        </div>
      </div>
