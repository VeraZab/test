  ...
  <div>
    <ContentSection>
      <ContentPane half center-vertically text>
        <div className="pre-title">Plotly for R and Shiny</div>
    ...
    <ContentSection>
      ...
      <ContentPane half center-vertically text>
        <Title>Supercharged graphics for R Shiny</Title>
        <Body>
          <p>
            Love R Shiny? Try adding Plotly charts for supercharged interactive
            graphics and cross filtering.
          </p>
        </Body>
      </ContentPane>
    </ContentSection>
    ...
    <ContentSection>
      <ContentPane half center-vertically text>
        <Title>Add interactivity to ggplot2 charts</Title>
        <Body>
          <p>
            No need to learn a new chart syntax: One line of code converts a
            ggplot2 static chart to an interactive Plotly version.
          </p>
          <p>
            <a
              href="https://cpsievert.github.io/plotly_book/extending-ggplotly.html#extending-ggplotly"
              target="_blank"
            >
              Learn More
            </a>
      ...
      <ContentPane half graphic>
        <Graphic image="https://images-plotly.imgix.net/static/marketing/product/ggplot2.png?auto=compress&auto=format" />
      </ContentPane>
    </ContentSection>
    ...
    <ContentSection>
      ...
      <ContentPane half center-vertically text>
        ...
        <Body>
          <p>
            Make D3.js and WebGL charts with the ease, power, and open-source
            ecosystem of R. Plotly charts and dashboards can be easily styled in
            R, or uploaded to Plotly’s online editor for point-&-click styling
            and collaboration.
          </p>
          <p>
            <a href="http://plot.ly/r" target="_blank">
              Learn More
            </a>
          </p>
        </Body>
    ...
    <ContentSection>
      <ContentPane half graphic>
        <Graphic image="https://images-hoshi.nationalmachine.co/ineffable/uploads/95aa3dc80638bd314e7085f1f561e2d8/DSC02407.jpg?w=1800&h=1800&crop=fit&q=80&auto=compress&auto=format" />
      </ContentPane>
      <ContentPane half center-vertically text>
        <div className="pre-title">PLOTCON NYC 2017</div>
        <Title>Plotly in R Master Class</Title>
        <Body>
          <p>
            Send your team to a{' '}
            <a href="https://plotcon.plot.ly/" target="_blank">
              PLOTCON workshop
            </a>{' '}
            to level up their skills in R visualization and Shiny app
            development. Workshops are, held twice per year in NYC and the West
            Coast. We can also hold custom workshops on-site at your company.
          </p>
          <p>
            Interested in getting instructed in Plotly for R from the people who
            made it? Carson will walk you through the Plotly R package in
            RStudio and R Shiny at PLOTCON NYC 2017 (Nov 14-17, 2017).
          </p>
          ...
          <ul>
            ...
            <li>
              Bring your own Plotly/R projects to get help and feedback from the
