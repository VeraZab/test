...
export default () => (
  <ContentSection className="background-color-light-4 no-padding-mobile">
    <ContentPane half center-vertically text className="thirty-five">
      <div className="pre-title">Business Intelligence</div>
      <Title>
        Plotly's agile BI platform lets you create and share everything you
        need.
      </Title>
      <Body>
        <p>
          Plotly offers unlimited public file hosting through its free
          community&nbsp;plan. With paid plans, you can host unlimited private
          files on Plotly’s&nbsp;platform.
        </p>
      </Body>
    </ContentPane>
      ...
      <div className="grids">
        <div className="grid grid-3x3">
          <div className="grid-item">
            <a
              href="https://plot.ly/organize/home?create=grid"
            ...
            >
              ...
              <div className="card-label">
                <div className="card-label-text">Data Sets</div>
              </div>
            </a>
          </div>
          ...
          <div className="grid-item">
            ...
            >
              ...
              <div className="card-label">
                <div className="card-label-text">D3.js Dashboards</div>
              </div>
            </a>
          </div>
          ...
          <div className="grid-item">
            ...
            >
              ...
              <div className="card-label">
                <div className="card-label-text">D3.js Charts</div>
              </div>
            </a>
          </div>
        </div>
        <div className="grid grid-3x3">
          <div className="grid-item">
            ...
            >
              ...
              <div className="card-label">
                <div className="card-label-text">SQL Queries</div>
              </div>
            </a>
          </div>
          ...
          <div className="grid-item">
            ...
            >
              ...
              <div className="card-label">
                <div className="card-label-text">Slide Decks</div>
              </div>
            </a>
          </div>
          <div className="grid-item">
            <a
              href="https://plot.ly/~empet/14352"
              target="_blank"
              className="card center
                                card-simple"
            >
              ...
              <div className="card-label">
                <div className="card-label-text">Jupyter Notebooks</div>
              </div>
            </a>
          </div>
        </div>
