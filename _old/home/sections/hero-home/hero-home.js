...
const HeroWrapperStyle = {
  backgroundImage:
    'url(https://images-plotly.imgix.net/plotly-marketing-pages/images/new-branding/illustrations/heroes/hero-home@2x.png?auto=compress&auto=format)',
  ...
  render() {
    return (
      <Hero heroWrapperStyle={HeroWrapperStyle}>
        <HeroTop>
          <HeroMessaging>
            <HeroTitle>Visualize Data, Together</HeroTitle>
            <HeroSubtitle>
              Plotly lets users easily create interactive charts and dashboards
              to share online with their audience.
            </HeroSubtitle>
          </HeroMessaging>
          <HeroActions>
