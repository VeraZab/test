...
export default () => (
  <ContentSection className="center dark-blue background--tunnels">
    <ContentPane full center center-vertically>
      ...
      <Title>Easily import data to chart</Title>
      <Body>
        <p>
          Connect your data to our platform. Within minutes, start typing SQL.<br />
          <em>No database?</em> No problem. We also support csv imports and
          manual data entry.
        </p>
        <div className="logos-display gutter-top">
          <div className="logos-display-wrapper">
            <div className="logo-item">
              <img
                src="https://marketing.plot.ly/static/marketing/assets/images/sql-logos/mysql.png?auto=compress&auto=format"
                alt="MySQL"
              />
            </div>
            <div className="logo-item">
