            ...
            <div className="card-wrapper">
              ...
              <div className="card-details">
                ...
                <div className="sub-title">
                  Upload Excel/CSV data or query a SQL database.
                </div>
              </div>
            </div>
            <div className="card-bg-element number">1</div>
          </div>
          <div className="card hidden card-simple dark-blue">
            <div className="card-wrapper">
              <div className="card-avatar">
              ...
              <div className="card-details">
                ...
                <div className="sub-title">
                  Create D3.js charts and dashboards by clicking, coding, or a
                  little of both.
                </div>
              </div>
            </div>
            <div className="card-bg-element number">2</div>
          </div>
          <div className="card hidden card-simple dark-blue">
            <div className="card-wrapper">
              <div className="card-avatar">
            ...
            <div className="card-bg-element number">3</div>
          </div>
        </div>
      </Body>
    </ContentPane>
