...
const languages = [
  {
    ...
    code: pythonCode,
    graphic_src:
      'https://images-plotly.imgix.net/static/marketing/python_graphic.gif',
    example_url:
      'https://images-plotly.imgix.net/static/marketing/python_graphic.gif',
  ...
  },
  {
    ...
    code: rCode,
    graphic_src:
      'https://images-plotly.imgix.net/static/marketing/r_graphic.gif',
    example_url:
      'https://images-plotly.imgix.net/static/marketing/r_graphic.gif',
  ...
  },
  {
    ...
    code: matlabCode,
    graphic_src:
      'https://images-plotly.imgix.net/static/marketing/matlab_graphic.gif',
    example_url:
      'https://images-plotly.imgix.net/static/marketing/matlab_graphic.gif',
      ...
      <div className="code-explorer gutter-top">
        ...
        <div className="code-explorer-wrapper">
          <div className="code-explorer-graphic">
            <div
              className="code-explorer-graphic-wrapper"
              style={graphicStyles}
            />
          </div>
          <div className="code-explorer-editor">
            <div className="code-explorer-editor-wrapper">
              <div className="code-explorer-editor-header">{tabs}</div>
              ...
              <div className="code-explorer-editor-actions">
                <div className="buttons">
                  <a
                    href={this.state.language.button_link}
                    className="button button-primary button-emerald"
                  >
