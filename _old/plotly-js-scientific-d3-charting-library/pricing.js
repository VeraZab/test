...
const pricingLevels = [
  {
    ...
    features: [
      ...
      {
        value:
          'Hands-on assistance with all of our Plotly API wrappers and PlotlyJS',
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        value:
          'For teams who want to level-up their chart and dashboard skils in JavaScript, Plotly holds 2-day workshops in NYC and the west coast twice per year. We can also hold a custom training on-site at your company.',
      },
    ],
  },
  {
      ...
      if (item.price.monthly === '0') {
        return (
          <div className="notes">
            ...
            <div className="billed-amount">Free forever.</div>
          </div>
        )
      } else {
        return (
